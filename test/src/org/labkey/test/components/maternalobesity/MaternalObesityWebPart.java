...
package org.labkey.test.components.maternalobesity;
 ...
 */
public class MaternalObesityWebPart extends BodyWebPart<MaternalObesityWebPart.ElementCache>
{
    public MaternalObesityWebPart(WebDriver driver)
    {
        this(driver, 0);
    }

    public MaternalObesityWebPart(WebDriver driver, int index)
    {
        super(driver, "maternalobesity", index);
    }

    public MaternalObesityWebPart setInput(String value)
    {
